			...
			<div className="w-[210mm] max-w-[210mm] mx-auto bg-white shadow-lg py-0 print:my-0 print:shadow-none print:border-none">
				<div className="grid grid-cols-1 md:grid-cols-12 print:grid-cols-12">
					<aside className="bg-blue-800 text-white p-6 py-10 space-y-6 md:col-span-4 print:col-span-4 font-arial">
						<ProfileHeader role="Développeur Mobile" />
						<ContactInfo />
					...
					<main className="p-6 py-10 space-y-4 md:col-span-8 print:col-span-8 font-arial">
						<section>
							...
							<p className="text-sm">
								Développeur Mobile passionné, je suis à la recherche d&apos;une
								alternance à partir de septembre 2025. Mon objectif est de
								contribuer à des projets innovants en exploitant mes compétences
								en développement d&apos;applications mobiles natives et
								hybrides, tout en approfondissant mes connaissances en génie
