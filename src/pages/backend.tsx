...
export default function BackendCV() {
	return (
		<div className="min-h-screen bg-gray-100 text-gray-900 font-sans print:bg-white print:py-0 print:m-0">
			<div className="w-[210mm] max-w-[210mm] mx-auto bg-white shadow-lg py-0 print:my-0 print:shadow-none print:border-none">
				<div className="grid grid-cols-1 md:grid-cols-12 print:grid-cols-12">
					<aside className="bg-blue-800 text-white p-6 py-6 space-y-6 md:col-span-4 print:col-span-4 font-arial">
						<ProfileHeader role={"Développeur Backend"} />
						<ContactInfo />
					...
					<main className="p-6 py-4 space-y-4 md:col-span-8 print:col-span-8 font-arial">
            ...
            <section>
              ...
              <p className="text-sm">
                Développeur Backend passionné, je suis à la recherche d&apos;une
                alternance à partir de septembre 2025. Mon objectif est de
                contribuer à des projets complexes en mettant à profit mes
                compétences en conception d&apos;API, gestion de bases de
                données et optimisation des performances, tout en continuant à
                me perfectionner en génie logiciel au sein d&apos;une entreprise
                innovante.
              </p>
            </section>
						<Education />
