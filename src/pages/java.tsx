...
export default function JavaCV() {
	return (
			...
			<div className="w-[210mm] max-w-[210mm] mx-auto bg-white shadow-lg py-0 print:my-0 print:shadow-none print:border-none">
				<div className="grid grid-cols-1 md:grid-cols-12 print:grid-cols-12">
					<aside className="bg-blue-800 text-white p-6 py-10 space-y-6 md:col-span-4 print:col-span-4 font-arial">
						<ProfileHeader role="Développeur Java"/>
						<ContactInfo />
              ...
              <p className="text-sm">
                Développeur Java passionné, en recherche d&apos;une alternance à
                ...
                Java, Spring Boot et microservices, tout en poursuivant mon
                perfectionnement en génie logiciel au sein d&apos;une entreprise
                dynamique.
              </p>
						</section>
						<Education />
