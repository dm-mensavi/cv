...
import UiuxSkills from "@/components/skills/UiuxSkills";

export default function FrontendCV() {
	return (
			...
			<div className="w-[210mm] max-w-[210mm] mx-auto bg-white shadow-lg py-0 print:my-0 print:shadow-none print:border-none">
				<div className="grid grid-cols-1 md:grid-cols-12 print:grid-cols-12">
					<aside className="bg-blue-800 text-white p-6 py-10 space-y-6 md:col-span-4 print:col-span-4 font-arial">
						<ProfileHeader role="Développeur Frontend"/>
						<ContactInfo />
					...
					<main className="p-6 py-10 space-y-4 md:col-span-8 print:col-span-8 font-arial">
						<section>
							...
							<p className="text-sm">
								Développeur Frontend en recherche d&apos;une alternance à partir
								de septembre 2025, je souhaite contribuer à des projets
								innovants en mettant à profit mes compétences en développement
								d&apos;interfaces utilisateur modernes et réactives, tout en
								poursuivant mon perfectionnement en génie logiciel et design
								d&apos;interfaces au sein d&apos;une entreprise dynamique.
							</p>
						</section>
						<Education />
